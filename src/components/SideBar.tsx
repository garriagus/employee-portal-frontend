  ...
  return (
    <>
      <button
        ...
        className="fixed top-4 left-4 z-50 text-gray-900 dark:text-white z-20"
      >
        <svg
          className="w-6 h-6"
          fill="none"
      ...
      {isSidebarVisible && (
        <aside
          id="sidenav-1"
          className="z-10 absolute left-0 top-10 z-[1035] h-full w-60 -translate-x-full overflow-hidden bg-white shadow-[0_4px_12px_0_rgba(0,0,0,0.07),_0_2px_4px_rgba(0,0,0,0.05)] data-[te-sidenav-hidden='false']:translate-x-0 dark:bg-zinc-800"
